...
@section('contenu')
    ...
    <!--Section: FAQ-->
    <div class="container-fluid pt-5 my-5 animate" data-animate="zoomIn" data-duration="1.0s" data-delay="0.1s">
    ...
    <div class="container my-5">
        ...
        <section>
            ...
            <p class="lead text-muted mx-auto mt-4 pt-2 mb-5 text-center">
                Got a question? We've got answers. If you have some other questions, see our support center.</p>
