...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('images/logo/icon-ac-group.png')}}" type="image/x-icon">
...
<section id="nav-bar">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="topSection">
    ...
    <div class="container">
      ...
      <a class="navbar-brand font-montserrart" href="{{ url('')}}">AC GROUP</a>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav ml-auto smooth-scroll">
          ...
          <li class="nav-item">
            <a class="nav-link @if($locale=='fr') disabled @endif" href="{{ url('lang','fr') }}">
                <img src="{{asset('images/fr.svg')}}" alt="">
            </a>
          </li>
  
          <li class="nav-item">
              <a class="nav-link @if($locale=='en') disabled @endif" href="{{ url('lang','en') }}">
      ...
      <div class="container">
        <div class="row wow fadeIn">
          ...
          <div class="col-md-12 mb-4 white-text animated text-center wow flipInX">
            ...
            <h4 class="display-3 font-weight-bold white-text mb-0 pt-md-5 pt-5">
              @yield('intro-title')
            </h4>
            <hr class="hr-light my-4 w-75">
            <h5 class="subtext-header mt-2 mb-4"> 
              @yield('intro-description')
            </h5>
